    ...
    <div class="container">
        ...
        <div class=" main-content-area">
            ...
            <div class="summary">
                <div class="order-summary">
                    ...
                    @if (Session::has('coupon'))
                        ...
                        <p class="summary-info"><span class="title">Subtotal with Discount
                            </span><b class="index">${{ $subtotalAfterDiscount }}</b></p>
            ...
            <div class="update-clear">
                <a class="btn btn-clear" href="#" wire:click.prevent="destroyAll()">Clear
                    Shopping Cart</a>
